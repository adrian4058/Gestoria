...
const Budgets: React.FC = () => {
  ...
  return (
    <div className="flex justify-between">
      <div className="flex w-full justify-between content">
        <div>
          <h2 className="font-black text-[#1B9AAA] text-4xl underline">
            Presupuestos
          </h2>
          <p className="w-3/4 text-justify text-gray-600 font-medium">
            En <b>Gestoría Adriana</b>, entendemos lo importante que es tener
            una gestión adecuada de tus vehículos. Por eso, te ofrecemos
            presupuestos personalizados para cada uno de tus trámites
            automotores. Nuestro equipo de expertos en automóviles está aquí
            para ayudarte a simplificar y agilizar cualquier gestión relacionada
            con tus vehículos. ¿Por qué elegir nuestros presupuestos? <br />{" "}
            <br />
            {"-"}
            <b>Experiencia y Conocimiento:</b> Contamos con una sólida
            experiencia en el campo y está familiarizado con todas las leyes y
            normativas relacionadas con trámites automotores. <br />
            {"-"}
            ...
            detallados, sin costos ocultos. Queremos que tengas total confianza
            en nuestros servicios. <br />
            ...
            inversión en tus vehículos. Nuestro objetivo es proteger tu
            patrimonio y garantizar que todo esté en regla. <br />{" "}
            <b>-Compromiso con la Calidad:</b> Nos enorgullecemos de brindar un
            servicio de alta calidad en cada uno de nuestros trámites
            automotores.
          </p>
        </div>
        <form
          ...
          action=""
        >
          <h2 className="font-black text-[#1B9AAA] text-xl ">
